...
const ImageUpload = ({ images, setImages }) => {
  ...
  return (
    <div className="w-full mt-4 col-span-3 lg:col-span-1">
      {/* Upload Box */}
      <div className="flex items-center justify-center w-full">
        <label
          htmlFor="dropzone-file"
          className="flex flex-col items-center justify-center w-full min-h-[185px] bg-[#FBFBFB] border-2 border-dashed border-[var(--button-bg)] rounded-[12px] cursor-pointer"
        >
          ...
          {images.map((img, index) => (
            ...
            >
              ...
              <button
                ...
                className="absolute -top-2 -right-2 bg-black/70 text-white rounded-full w-4 h-4 flex items-center justify-center"
              >
